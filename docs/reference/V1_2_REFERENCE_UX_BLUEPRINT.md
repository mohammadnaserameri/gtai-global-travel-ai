...
| 07  | Flight Details and Affiliate Redirect | **Partially frozen**     | Partial           | Partial                | **Partial — outbound _preview_ placeholder only** | V2.5 / V2.5.1          | `docs/reference/07_PROVIDER_INTEGRATION_BLUEPRINT.md` | partially frozen locally                   |
...
- **Module 07** (Flight Details and Affiliate Redirect) is **partially frozen**, not implemented. Frozen: the **affiliate outbound _preview_ placeholder** (a local, non-redirecting interstitial that explicitly previews rather than performs a hand-off) and the **forward-looking real-provider blueprint and type contract**, specified in `docs/reference/07_PROVIDER_INTEGRATION_BLUEPRINT.md` and implemented in **V2.5** (base `16606abe4dd33b41203a54c11b586f1325eab5f7`), corrected in **V2.5.1**. Pending: a dedicated Flight Details route/page (not analyzed), a real Provider Adapter, live inventory, and a real affiliate redirect. Booking and payment remain permanently outside GTAI core — see `docs/implementation/V2_5_FLIGHT_RESULTS_POLISH_AND_OUTBOUND_BLUEPRINT.md` for known limitations.
