...
Names and boundaries only. **No requirements exist for module 07**, and none may be inferred from this list. Modules 02, 03, 04, 05 and 06 have since been documented and are no longer listed here.
...
| 06  | Filters and Sorting                   | **Documented with V2.4** | Yes               | Yes                    | **Yes — implemented in V2.4 (frozen locally)** | V2.4                   | `docs/reference/06_FLIGHT_FILTERS.md`                 | frozen locally                             |
