...
| ------- | ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| V2      | Functional Flight Search Foundation | **In progress** — V2.1 Airport Selector, V2.2 Date Picker, V2.2.1 accessibility polish, V2.3 Search Intent and Results foundation, and V2.4 Functional Flight Filters all frozen locally. Real providers, affiliate redirect and booking remain pending. |
...
| `docs/implementation/V2_4_FUNCTIONAL_FLIGHT_FILTERS.md`   | V2.4 implementation record for Flight Filters, frozen locally                                                           |
