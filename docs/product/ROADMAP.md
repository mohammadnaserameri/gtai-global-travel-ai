...
| V1.2-G      | Flight Details and Affiliate Redirect | **Partially frozen** — frozen: the outbound _preview_ placeholder and the provider integration blueprint/type contract (V2.5, corrected in V2.5.1). Implemented in V2.6 (uncommitted): the dedicated Flight Details route. Pending: a real Provider Adapter, live inventory and a real affiliate redirect. Booking and payment remain permanently outside GTAI core. | —                                          |
...
| ------- | ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| V2      | Functional Flight Search Foundation | **In progress** — V2.1 Airport Selector, V2.2 Date Picker, V2.2.1 accessibility polish, V2.3 Search Intent and Results foundation, V2.4 Functional Flight Filters, V2.5 Flight Results Polish, Affiliate Outbound Placeholder and Provider Integration Blueprint, and V2.5.1 Results Truthfulness and Provider Blueprint Corrections all frozen locally (V2.5.1 at `c711662a…`). V2.6 Functional Flight Details is implemented and uncommitted. Real providers, live inventory, real affiliate redirects and booking/payment remain pending. |
...
| `docs/reference/07_PROVIDER_INTEGRATION_BLUEPRINT.md`                      | V1.2-G forward-looking provider adapter blueprint (partially frozen); the outbound preview placeholder it targets is implemented in V2.5                       |
| `docs/reference/08_FLIGHT_DETAILS.md`                                      | V1.2-G Flight Details half — route contract, resolution pipeline, itinerary/fare/price scope; implemented in V2.6                                              |
| `docs/reference/09_PROVIDER_RUNTIME.md`                                    | Server-side provider runtime: boundary, registry, adapter lifecycle, internal API, cancellation, validation, audit; implemented locally through V2.7           |
...
| `docs/implementation/V2_5_FLIGHT_RESULTS_POLISH_AND_OUTBOUND_BLUEPRINT.md` | V2.5 implementation record for Results Polish, the outbound preview placeholder and the provider blueprint, frozen locally at `16606abe…`; corrected in V2.5.1 |
| `docs/implementation/V2_6_FUNCTIONAL_FLIGHT_DETAILS.md`                    | V2.6 implementation record for the Flight Details page, frozen at `7f0d6ba0…`                                                                                  |
| `docs/implementation/V2_7_FUNCTIONAL_PROVIDER_RUNTIME.md`                  | V2.7 implementation record for the provider runtime and internal search API, built on V2.6 `7f0d6ba0…` (uncommitted)                                           |
